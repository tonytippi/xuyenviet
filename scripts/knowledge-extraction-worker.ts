...
function loadWorkerEnv() {
  for (const name of ["DATABASE_URL", "AI_GATEWAY_BASE_URL", "AI_GATEWAY_API_KEY", "AI_GATEWAY_TIMEOUT_MS", "AI_GATEWAY_EXTRACTION_TIMEOUT_MS", "KNOWLEDGE_EXTRACTION_WORKER_POLL_MS", "KNOWLEDGE_EXTRACTION_WORKER_STALE_MS"]) {
