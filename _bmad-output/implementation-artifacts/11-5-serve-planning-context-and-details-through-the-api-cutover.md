...
- 2026-07-30 final Epic 11 ledger repair shared with Story 11.1: compact, minimal, and essential source-bundle variants now persist and serialize only the typed conflicts actually emitted by their final conflict section, respectively 10, 1, or 0. PostgreSQL regressions prove final-section/snapshot/serialization/digest correspondence. No further review was run. Story status remains done; Epic 11 is synchronized to done by user direction.
