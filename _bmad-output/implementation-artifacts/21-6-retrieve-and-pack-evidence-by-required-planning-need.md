...
1. Retrieval creates deterministic versioned requirement keys before candidate generation and uses them through selection, rendering, provenance, and evaluation.
...
4. Final coverage recomputes from the prompt-render manifest, not card count. `RN-01` through `RN-07` pass.
