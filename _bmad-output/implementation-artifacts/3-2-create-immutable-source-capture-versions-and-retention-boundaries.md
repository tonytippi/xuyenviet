...
- Capture remains an operator-controlled Playwright operations tool, never a public route, traveler action, or unattended mass crawler. [Source: `ARCHITECTURE-SPINE.md:152-166`; `docs/runbooks/facebook-capture.md`]
