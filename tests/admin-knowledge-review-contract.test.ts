...
import { parseAdminKnowledgeCard, parseAdminKnowledgeCardList, parseAdminKnowledgeRecommendationDetail, parseAdminKnowledgeRecommendationList } from "@xuyenviet/contracts";

const card = { id: "card-1", type: "place", title: "Điểm dừng", locationName: "Huế", routeSegment: null, summary: "Thông tin có bằng chứng.", practicalDetails: {}, tags: [], confidence: "community", freshnessSensitive: false, lifecycleState: "active", knowledgeState: "community_observation", verificationRequirement: "none", updatedAt: "2026-08-04T00:00:00.000Z", createdAt: "2026-08-03T00:00:00.000Z", sources: [], indexStatus: { state: "indexed", label: "Đã index", documentStatus: "active", indexedAt: "2026-08-04T00:00:00.000Z" } };
