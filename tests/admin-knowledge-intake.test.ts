...
describe("admin knowledge intake URL normalization", () => {
  test("canonicalizes safe URLs and classifies capture sources", () => {
    expect(normalizeIntakeUrl("https://www.youtube.com/watch?t=8s&v=abcDEF12345&utm_source=feed#about")).toEqual({ url: "https://www.youtube.com/watch?v=abcDEF12345", hostname: "www.youtube.com", kind: "youtube" });
