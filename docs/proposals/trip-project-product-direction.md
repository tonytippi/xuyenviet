...
Đích đến là mỗi Trip Project có **một conversation chính**. Người dùng dùng conversation này để hỏi, sửa và điều chỉnh toàn bộ chuyến đi; không cần chọn nhiều chat session cho cùng một trip. Hiện tại đây chưa phải invariant dữ liệu: một Trip Project có thể có nhiều conversation liên kết, nên yêu cầu này cần migration và UX transition riêng.
...
- Sau migration, một Trip Project có một conversation chính; trước đó cần giữ tương thích với nhiều conversation liên kết hiện có.
