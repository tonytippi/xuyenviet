...
const steps = [
  ...
  { number: "04", title: "Duyệt bản nháp AI", body: "Bản nháp là đề xuất, chưa phải tri thức dùng cho du khách. Kiểm tra claim, nguồn, độ tin cậy, điều kiện áp dụng và cờ thông tin có thể thay đổi theo thời gian trước khi quyết định.", href: "/knowledge/drafts", action: "Mở bản nháp" },
