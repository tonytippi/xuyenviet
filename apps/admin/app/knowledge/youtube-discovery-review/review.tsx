...
export function YoutubeDiscoveryReview() {
  ...
  async function load(nextCursor: string | null, initial = false) {
    ...
    try {
      ...
      if (initial && queue.items[0]) choose(queue.items[0]);
