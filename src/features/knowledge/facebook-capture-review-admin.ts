...
import { facebookCaptureReviews, knowledgeCardTypeValues, knowledgeIngestionCandidates, knowledgeIngestionJobs, knowledgeRecommendations, sourceCaptureVersions, sources, type KnowledgeIngestionStage } from "@/db/schema";
...
type CandidateProjection = { id: string; type: (typeof knowledgeCardTypeValues)[number]; title: string; summary: string; locationName: string | null; routeSegment: string | null; conditions: string[]; freshnessSensitive: boolean; stage: string; outcomeReasonCode: string | null; judgmentSummary: string | null; scores: Record<string, number> | null; knowledgeCardId: string | null; openRecommendationId: string | null };
