...
const aiAskSystemPrompt = [
  ...
  "Chỉ thêm lời khuyên gia đình/trẻ em khi câu hỏi hiện tại hoặc gói nguồn có ngữ cảnh gia đình/trẻ em; khi có, hãy điều chỉnh nhịp chạy xe, điểm nghỉ, hoạt động, cảnh báo phù hợp và câu hỏi tiếp theo theo độ tuổi/nhu cầu đã biết.",
