...
export default async function KnowledgeRecommendationsPage({ searchParams }: Props) {
  ...
  const recommendations = await listKnowledgeRecommendations({ page: Number(params.page) || 1, status: params.status, reason: params.reason as never });
  return <div>
