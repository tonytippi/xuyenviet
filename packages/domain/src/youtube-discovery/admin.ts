...
export type AdminYoutubeDiscoveryPort = {
  ...
  admitImmediateRun(principal: RequestPrincipal, queryId: string, confirmationKey: string): Promise<AdminYoutubeDiscoveryImmediateRunResult | null>;
  getQueryProgress(queryId: string, runId: string | null): Promise<AdminYoutubeDiscoveryQueryProgress | null>;
