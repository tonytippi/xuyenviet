...
export type { TripHomeFocusKind } from "./trip-home-labels";
...
// in the proposal module) so the presentational workspace panel can import the
// type without pulling in its implementation.
