...
export async function approveKnowledgeDraftBatchForActorInTransaction(transaction: ReviewMutationDb, actor: { userId: string; email: string }, draftIds: string[]): Promise<{ draftIds: string[] }> {
