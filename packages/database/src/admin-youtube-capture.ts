...
type Row = { sourceId: string; sourceLabel: string; sourceUrl: string | null; sourceCanonicalUrl: string | null; createdAt: Date; rawText: string | null; captureMethod: string | null; capturedAt: string | null; model: string | null; promptVersion: string | null; jobId: string | null; jobStatus: "queued" | "running" | "completed" | "failed" | null; jobUpdatedAt: Date | null };
