...
ALTER TABLE "knowledge_card_search_documents" ADD CONSTRAINT "knowledge_card_search_documents_executor_system_check" CHECK ("executor_system" is null or length(btrim("executor_system")) between 1 and 160);--> statement-breakpoint
